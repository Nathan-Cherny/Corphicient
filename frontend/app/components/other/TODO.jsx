    ...
    <div className="flex flex-col bg-white p-5 justify-center">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex flex-col gap-5">
          ...
          <ul>
            <li>
              Big thing is making fadedisplays for EDITING songs and playlists.
            </li>
            <li>
              every song and playlist has an edit button, click it, you can
              delete / change names / crop song / change whatever for that song
              or playlist
            </li>
            <br />
        ...
        <div className="flex flex-col gap-5">
          ...
          <ul>
            <li>record stop/start/break for xsotec logging</li>
          </ul>
        </div>
      </div>
    </div>
